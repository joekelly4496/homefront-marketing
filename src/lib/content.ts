...
export const brand = {
  ...
  category:
    'post-closing software platform for residential home builders',
  /**
...
export type Commitment = { icon: LucideIcon; title: string; description: string };
